...
//    }
	...
	private Arm(){
		...
		CANTalon fakeMotor1= new CANTalon(7);
		CANTalon fakeMotor2= new CANTalon(8);
		myDrive= new RobotDrive(fakeMotor1, fakeMotor2, leftMotor, rightMotor); //does this flip a motor? make sure we won't repeat the same mistake.
